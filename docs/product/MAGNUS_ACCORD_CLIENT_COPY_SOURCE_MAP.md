...
| Connector panel keys + pilot-only rows + Claude status | [MAGNUS_ACCORD_CONNECTOR_REGISTRY.md](./MAGNUS_ACCORD_CONNECTOR_REGISTRY.md), [MAGNUS_ACCORD_FEATURE_DIRECTORY.md](./MAGNUS_ACCORD_FEATURE_DIRECTORY.md) |
| MCP stub / non-truth caveat | [PRODUCTION_TRUTH_CHECKLIST.md](../PRODUCTION_TRUTH_CHECKLIST.md) §4, [MAGNUS_ACCORD_MATURITY_MAP.md](./MAGNUS_ACCORD_MATURITY_MAP.md) |
